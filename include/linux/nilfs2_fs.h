...
#define NILFS_FEATURE_COMPAT_TRACK_SNAPSHOTS_DEF	(1ULL << 2)
#define NILFS_FEATURE_COMPAT_TRACK_SNAPSHOTS_HALF	(1ULL << 3)
#define NILFS_FEATURE_COMPAT_TRACK_SNAPSHOTS_FULL	(1ULL << 4)
